...
class BandsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create band" do
    assert_difference('Band.count') do
      post bands_url, params: { band: { current_label: @band.current_label, form_year: @band.form_year, name: @band.name } }
    end
  ...
  test "should update band" do
    patch band_url(@band), params: { band: { current_label: @band.current_label, form_year: @band.form_year, name: @band.name } }
